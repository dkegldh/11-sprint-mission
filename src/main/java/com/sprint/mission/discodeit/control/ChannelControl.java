...
public class ChannelControl {
    ...
    public ResponseEntity<ChannelDto> createPrivateChannel(@RequestBody PrivateChannelRequest request) {
    ...
    public ResponseEntity<Void> updateChannel(@PathVariable UUID id, @RequestBody ChannelUpdate request) {
