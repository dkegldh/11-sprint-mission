...
public class UserControl {
    public static void controlUserMenu(Scanner input, UserService userService) {
        while(true) {
            System.out.println(
                ...
                switch (menu) {
                        ...
                        while(true) {
                            try {
                                ...
                                for (int i = 0; i < readUserList.size(); i++) {
                                    ...
                                    System.out.println((i + 1) + ". 유저이름 : " + ru.getUsername() + ", 생성시간 : " + ru.getCreatedAt());
                                }
                                ...
                                UUID readId = readUser.getId();
                                User user = userService.readUser(readId);
                                System.out.println("조회성공! " + user);
                                break;
                            } catch (IllegalArgumentException e) {
                    ...
                    case DELETE:
                        while(true) {
                            try {
                                ...
                                UUID deleteId = deleteUser.getId();

                                System.out.print("패스워드를 입력해주세요 : ");
                                String deletePassword = input.nextLine();
                                System.out.println();

                                userService.deleteUser(deleteId, deletePassword);
                    ...
                    case UPDATE:
                        try {
                            ...
                            System.out.println();
                            userService.updateUser(id, updateName, updateEmail, updatePassword);
                            break;
                        } catch (IllegalArgumentException e) {
